...
namespace ns4 {
	...
	public :
		...
		bool										LoPass( const double _dFs, double _dFreq1_Cutoff, uint32_t _ui32FilterOrder,
			...
			return Coefficients( NS4_FT_LOPASS, _dFs, _dFreq1_Cutoff, 0.0, _ui32FilterOrder, _vCoeffs, _dOverallGain );
		}
		...
		bool										HiPass( const double _dFs, double _dFreq1_Cutoff, uint32_t _ui32FilterOrder,
			std::vector<CBiQuadFilter> &_vCoeffs, double &_dOverallGain ) {
			return Coefficients( NS4_FT_HIPASS, _dFs, _dFreq1_Cutoff, 0.0, _ui32FilterOrder, _vCoeffs, _dOverallGain );
		}
		...
		bool										BandPass( const double _dFs, double _dFreq1_Cutoff, double _dFreq2_Cutoff, uint32_t _ui32FilterOrder,
			std::vector<CBiQuadFilter> &_vCoeffs, double &_dOverallGain ) {
			return Coefficients( NS4_FT_BANDPASS, _dFs, _dFreq1_Cutoff, _dFreq2_Cutoff, _ui32FilterOrder, _vCoeffs, _dOverallGain );
		}
		...
		bool										BandStop( const double _dFs, double _dFreq1_Cutoff, double _dFreq2_Cutoff, uint32_t _ui32FilterOrder,
			std::vector<CBiQuadFilter> &_vCoeffs, double &_dOverallGain ) {
			return Coefficients( NS4_FT_BANDSTOP, _dFs, _dFreq1_Cutoff, _dFreq2_Cutoff, _ui32FilterOrder, _vCoeffs, _dOverallGain );
		}
		 ...
		 * \return Returns true if there were no errors gnerating the coefficients.
		 */
		bool										Coefficients( NS4_FILTER_TYPE _ftFilter, const double _dFs, const double _dFreq1_Cutoff, const double _dFreq2_Cutoff, const uint32_t _ui32FilterOrder,
			std::vector<CBiQuadFilter> &_vCoeffs, double &_dOverallGain );
		/**
